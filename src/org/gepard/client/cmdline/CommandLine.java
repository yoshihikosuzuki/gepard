...
public class CommandLine {
    ...
    private static final String[] ALLOWED_ARGS = new String[] {
            "seq1", "seq2", "maxwidth", "maxheight", "matrix", "silent", "word", "window", "from1", "to1",
            "from2", "to2", "lower", "upper", "greyscale", "onlyplot", "outfile", "format", "safile", "sasecondseq",
            "secondcomp", "zoom" };
    ...
    public static void main(String[] args) {
        ...
        if (!arguments.isSet("seq1") || !arguments.isSet("seq2") || !arguments.isSet("matrix")
                || !arguments.isSet("outfile")) {
            printUsage();
            System.exit(1);
        }
        ...
        if ((arguments.isSet("maxwidth") || arguments.isSet("maxheight")) && arguments.isSet("zoom")) {
            ...
            System.out.println(
                    "maxwidth/maxheight automatically implies a zoom factor whereas a zoom factor implies the plot size");
            System.exit(1);
        }
        ...
        // get parameter set
        ParameterSet params = new ParameterSet(false, -1, word, window, -1, -1, -1, -1,
                ClientGlobals.extractFilename(arguments.getValue("matrix").toLowerCase()));
        // set correct coordinates
        try {
            setCoordinates(params, seq1, seq2, arguments);

            params.onlyPlot = only_plot;
            ...
            if (arguments.isSet("zoom")) {
                ...
                height = (arguments.isSet("maxheight")) ? Integer.parseInt(arguments.getValue("maxheight"))
                        : DEF_HEIGHT;

                // calc zoom factor
                params.zoom = calcZoom(width, height, params.seq1Start, params.seq1Stop, params.seq2Start,
                        params.seq2Stop);
            }
        ...
        int[] seq1Starts = { 0 };
        if (seq1.isMulti()) {
            seq1Starts = seq1.getMultiStarts();
        }
        int[] seq2Starts = { 0 };
        if (seq2.isMulti()) {
            seq2Starts = seq2.getMultiStarts();
        }
        DotMatrix dm = new DotMatrix(seq1.getSequenceData(), seq2.getSequenceData(), seq1.getName(), seq1Starts,
                seq1.getNPos(), seq2.getName(), seq2Starts, seq2.getNPos(), sa, params, submat, catcher, catcher,
                saSecondSeq);
        ...
        plotter.reCalc((float) ((maxScore - minScore) * lower + minScore),
                (float) ((maxScore - minScore) * upper + minScore), greyscale);
    ...
    private static void setCoordinates(ParameterSet params, Sequence seq1, Sequence seq2,
    ...
    private static void printUsage() {
        ...
        System.err
                .println("  -format:      output format, one of:  'png', 'jpg', 'bmp' (default:" + DEF_OUTFORMAT + ")");
        System.err.println();
